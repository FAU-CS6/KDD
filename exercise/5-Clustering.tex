...
\newcommand{\CoordinateSystemWithCirclesAndConnections}[6]{
    \begin{center}
        ...
        \begin{tikzpicture}[scale=0.5]
			...
			% TODO
			%\foreach \coordinate [remember=\coordinate as \lastCoordinate (initially 0)] in {#5} {
			%	\ifnum\lastCoordinate=0
			%		\node[circle,draw,fill=white,scale=0.5] at (-1,-1) {};
			%	\else
			%		\draw[thick,->] \lastCoordinate -- \coordinate;
			%	\fi
			%}
...
\subsubsection*{Task 1.3: Density Reachable}

Determine whether $(1,1)$, $(2,1)$, $(2,3)$, and $(1,4)$ are \textbf{density reachable} from the core point $(1,2)$ if a density based clustering algorithm like \textbf{DBSCAN} is initialized with $\varepsilon = 1$ and $MinPts = 2$. The distance is calculated using the Euclidean distance.
...
\begin{solution}
	...
	\begin{itemize}
		\item \textbf{Point $(1,1)$:}
		      ...
		      \CoordinateSystemWithCirclesAndConnections{(1,1), (1,2)}{(1,4), (2,1), (2,3), (3,2), (3,4), (4,1), (4,3), (4,4)}{(1,2)}{1}{(1,1), (1,2), (3,2)}
