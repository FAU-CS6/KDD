...
% PDF Metadata
\metadata{4. Classification}{Classification, Decision Trees, Naïve Bayes, Machine Learning}{Hands-on exercises on classification techniques, including decision trees and Naïve Bayes, focusing on practical applications in machine learning and data mining.}
			      ...
			      \item \textbf{Calculate the Information Gain for all attributes:}
			            ...
			            \begin{enumerate}	
				            \item \textbf{Attribute \textit{Age}:}
				                  ...
				                  Therefore, the Information Gain for the attribute \textit{Age} is $0,0817$ (if we split at $25,0$).
