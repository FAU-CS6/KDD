...
% PDF Metadata
\metadata{1. Introduction to Python and pandas}{Python, pandas, Jupyter Notebook, Data Science, Programming, Data Analysis}{Introduction to Python and pandas for data analysis, covering installation, basic programming concepts, and data manipulation with pandas.}
