...
\newcommand{\metadata}[3]{
	\hypersetup{
		pdftitle={#1 - Knowledge Discovery in Databases with Exercises (Version \GITAbrHash)},
		pdfkeywords={KDD, KDDmUe, Knowledge Discovery in Databases, Knowledge Discovery in Databases with Exercises, FAU Erlangen-Nürnberg, Data Science, Machine Learning, Data Mining, Lecture, #2},
		pdfsubject={#3},
