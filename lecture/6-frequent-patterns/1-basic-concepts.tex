...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node<1-> (img1) at (0,0) [inner sep=0pt, blur shadow={shadow blur steps=20, shadow xshift=0.5ex, shadow yshift=-0.5ex}] {\includegraphics[height=0.4\textheight]{img/frequent-patterns-amazon.png}};
			%\node<1-> at (img1.south) [yshift=-0.5cm] {\scriptsize Amazon};
			\node<2-> (img2) at (3.5,-1) [inner sep=0pt, blur shadow={shadow blur steps=20, shadow xshift=0.5ex, shadow yshift=-0.5ex}] {\includegraphics[height=0.4\textheight]{img/frequent-patterns-bestbuy.png}};
			%\node<2-> at (img2.south) [yshift=-0.5cm] {\scriptsize Best Buy};
			\node<3-> (img3) at (7,-2) [inner sep=0pt, blur shadow={shadow blur steps=20, shadow xshift=0.5ex, shadow yshift=-0.5ex}] {\includegraphics[height=0.4\textheight]{img/frequent-patterns-mindfactory.png}};
