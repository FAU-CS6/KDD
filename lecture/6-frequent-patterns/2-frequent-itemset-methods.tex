...
\begin{frame}
	\begin{itemize}
		...
		\item \textbf{Often with a specialization. E.g.:}
		      \begin{itemize}
			      \item \textbf{ECLAT\footnote{\fullcite{zaki1997}}:} Mining in the
			            vertical data format.
			      \item \textbf{CLOSET\footnote{\fullcite{wang2003}}:} Mining closed itemsets.
			      \item \textbf{MaxMiner\footnote{\fullcite{bayardo1998}}:} Mining max-itemsets.
		      \end{itemize}
	\end{itemize}
\end{frame}
