...
\newcommand{\headertableheader}{
	\begin{tikzpicture}
		\node[draw, fill=white, minimum height = 0.65cm, minimum width=1.5cm] at (0,-1) (Item) {\textbf{Item}};
		\node[draw, fill=white, minimum height = 0.65cm, minimum width=1.5cm, right = 0cm of Item] {\textbf{Sum}};
	\end{tikzpicture}
}

\newcommand{\headertableentry}[2]{
	\begin{tikzpicture}
		\node[draw, fill=white, minimum height = 0.65cm, minimum width=1.5cm] at (0,-1) (Item) {$#1$};
		\node[draw, fill=white, minimum height = 0.65cm, minimum width=1.5cm, right = 0cm of Item] {$#2$};
	\end{tikzpicture}
}
			...
			\scalebox{0.75}{
				...
				\only<22>{
					\begin{tikzpicture}
						...
						% Header table
						\node[inner sep=0cm] at (-5,-0.5) (headertable) {\scalebox{0.7}{\headertableheader}};
						\node[inner sep=0cm, below=0cm of headertable]  (f-header) {\scalebox{0.7}{\headertableentry{f}{4}}};
						\node[inner sep=0cm, below=0cm of f-header] (c-header) {\scalebox{0.7}{\headertableentry{c}{4}}};
						\node[inner sep=0cm, below=0cm of c-header] (a-header) {\scalebox{0.7}{\headertableentry{a}{3}}};
						\node[inner sep=0cm, below=0cm of a-header] (b-header) {\scalebox{0.7}{\headertableentry{b}{3}}};
						\node[inner sep=0cm, below=0cm of b-header] (m-header) {\scalebox{0.7}{\headertableentry{m}{3}}};
						\node[inner sep=0cm, below=0cm of m-header] (p-header) {\scalebox{0.7}{\headertableentry{p}{3}}};

						%\node[text width=5cm, anchor=east] at (-2.4,-1.75) (header-table)
						%{
						%	\begin{tabular}{|c|c|c}
						%		\hhline{|-|-|~|}
						%		\textbf{Item} & \textbf{Sum} &           \\\hhline{|-|-|~|}
						%		f             & 4            & $\bullet$ \\\hhline{|-|-|~|}
						%		c             & 4            & $\bullet$ \\\hhline{|-|-|~|}
						%		a             & 3            & $\bullet$ \\\hhline{|-|-|~|}
						%		b             & 3            & $\bullet$ \\\hhline{|-|-|~|}
						...
						\node[inner sep=0.05cm] at (-1.05,-0.7) (f) {\scalebox{0.7}{\fptreenode{f}{4}}};
						\node[inner sep=0.05cm] at (-1.75,-1.4) (fc) {\scalebox{0.7}{\fptreenode{c}{3}}};
						\node[inner sep=0.05cm] at (-1.75,-2.1) (fca) {\scalebox{0.7}{\fptreenode{a}{3}}};
						\node[inner sep=0.05cm] at (-2.45,-2.8) (fcam) {\scalebox{0.7}{\fptreenode{m}{2}}};
						\node[inner sep=0.05cm] at (-2.45,-3.5) (fcamp) {\scalebox{0.7}{\fptreenode{p}{2}}};
						\node[inner sep=0.05cm] at (-1.05,-2.8) (fcab) {\scalebox{0.7}{\fptreenode{b}{1}}};
						\node[inner sep=0.05cm] at (-1.05,-3.5) (fcabm) {\scalebox{0.7}{\fptreenode{m}{1}}};
						\node[inner sep=0.05cm] at (-0.35,-1.4) (fb) {\scalebox{0.7}{\fptreenode{b}{1}}};
						\node[inner sep=0.05cm] at (1.05,-0.7) (c) {\scalebox{0.7}{\fptreenode{c}{1}}};
						\node[inner sep=0.05cm] at (1.05,-1.4) (cb) {\scalebox{0.7}{\fptreenode{b}{1}}};
						\node[inner sep=0.05cm] at (1.05,-2.1) (cbp) {\scalebox{0.7}{\fptreenode{p}{1}}};
						...
						\draw[->, color=faugraydark, dashed] (fc) .. controls (-0.5,-1.0) and (0.5,-0.7) .. (c);
						% A
						...
						\draw[->, color=faugraydark, dashed] (fcamp) .. controls (-1.05,-4) and (0.5,-4) .. (cbp);
