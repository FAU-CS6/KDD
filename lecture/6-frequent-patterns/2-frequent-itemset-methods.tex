		...
		\begin{column}{0.45\textwidth}
			...
			\scalebox{0.75}{
				\begin{tikzpicture}
						...
						\node[text width=5cm, anchor=north, below=0cm of original-dataset] (fp-tree)
						{
							\scalebox{0.7}{
								\begin{tikzpicture} [scale=1]
									...
									% TID 500
									\visible<21>{
										\node at (-1.5,-1) (f) {\fptreenode{f}{4}\tikzmark{f1}};
					...
					%\visible<22-23>{
					%	\node[text width=5cm, anchor=north] at (0,0) (header-table)
					%	{
					%		\begin{center}
					%			\visible<23->{
					%				\begin{tikzpicture}
					%					\node[text width=5cm, anchor=north] at (-5,0) (header-table) {
					%						\begin{tabular}{|c|c|c}
					%							\hhline{|-|-|~|}
					%							\textbf{Item} & \textbf{Sum} &                        \\\hhline{|-|-|~|}
					%							f             & 4            & $\bullet$\tikzmark{f0} \\\hhline{|-|-|~|}
					%							c             & 4            & $\bullet$              \\\hhline{|-|-|~|}
					%							a             & 3            & $\bullet$              \\\hhline{|-|-|~|}
					%							b             & 3            & $\bullet$              \\\hhline{|-|-|~|}
					%							m             & 3            & $\bullet$              \\\hhline{|-|-|~|}
