				...
				\item \textbf{Steps of FP-growth:}
				      \begin{enumerate}
					      ...
					      \item Perform the \textbf{2nd scan:}
					            \begin{itemize}
						            \item {\only<8,11>{\color{faugraydark}}Sort and filter the items in each tuple.}
						            \item {\only<9,12>{\color{faugraydark}}Construct the initial \textbf{FP-tree}}.
					            \end{itemize}
					            }
		...
		\begin{column}{0.45\textwidth}
			...
			\scalebox{0.75}{
				\begin{tikzpicture}
					\node[text width=5cm, anchor=north] at (0,0) (original-dataset)
					{
						\begin{center}
							\begin{tabular}{|c|c|}
								...
								300                                      & b,f,h,j,o,w                                                                        \\\hline
								400                                      & b,c,k,s,p                                                                          \\\hline
								500                                      & a,f,c,e,l,p,m,n                                                                    \\\hline
							\end{tabular} \\
							\vspace{0.2cm}
							$min\_sup=3$ \\
							\visible<5->{
					...
					\visible<9->{
						\node[text width=5cm, anchor=north, below=0.15cm of original-dataset] (fp-tree)
						{
							\begin{center}
								\scalebox{0.7}{
