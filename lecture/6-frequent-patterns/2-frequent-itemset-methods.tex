...
\newcommand{\headertableentrymarked}[2]{
	\begin{tikzpicture}
		\node[draw, fill=faureddark!20, minimum height = 0.65cm, minimum width=1.5cm] at (0,-1) (Item) {$#1$};
		\node[draw, fill=faureddark!20, minimum height = 0.65cm, minimum width=1.5cm, right = 0cm of Item] {$#2$};
	\end{tikzpicture}
}
						...
						\visible<25->{
							\node[text width=5cm, anchor=north] at (1,-5.5) (conditional-pattern-bases)
							{
								\begin{tabular}{|c|c|}
									...
									\only<27>{\cellcolor{faureddark!20}}c & \only<27>{\cellcolor{faureddark!20}}\visible<27->{f:3}             \\\hline
									\only<28>{\cellcolor{faureddark!20}}a & \only<28>{\cellcolor{faureddark!20}}\visible<28->{fc:3}            \\\hline
									\only<29>{\cellcolor{faureddark!20}}b & \only<29>{\cellcolor{faureddark!20}}\visible<29->{fca:1, f:1, c:1} \\\hline
									\only<30>{\cellcolor{faureddark!20}}m & \only<30>{\cellcolor{faureddark!20}}\visible<30->{fca:2, fcab:1}   \\\hline
									\only<31>{\cellcolor{faureddark!20}}p & \only<31>{\cellcolor{faureddark!20}}\visible<31->{fcam:2, cb:1}    \\\hline
								\end{tabular}
							};
						}
					}
