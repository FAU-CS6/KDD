		...
		\scalebox{0.875}{
			\begin{tikzpicture}[scale=1]
				...
				\only<4>{
					\node[text width=5cm, anchor=west] at (7.75,2.5,4) {
						\begin{block}{Hint (4)}
							\underline{The data cube itself:}
							\begin{itemize}
				...
				\only<5>{
					\node[text width=5cm, anchor=west] at (7.75,2.5,4) {
						\begin{block}{Hint (5)}
							\underline{A cube of cubes:}
							\begin{itemize}
								\item The cube can be sliced into smaller cubes
							\end{itemize}
							\underline{The smaller cubes:}
							\begin{itemize}
