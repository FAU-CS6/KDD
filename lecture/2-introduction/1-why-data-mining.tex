...
\begin{frame}{Why Data Mining? (II)}
	\begin{figure}
		...
		\begin{tikzpicture}[scale=1]
			\begin{axis}[
					width=0.9\textwidth, height=0.875\textheight,
					ybar,
					symbolic x coords={2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024},
					xtick=data,
					xticklabel style={rotate=45, anchor=east},
					ymin=0,
					ymax=180,
					ylabel={Annual data volume generated \\ (in Zettabytes)\footnote{Source: \url{https://de.statista.com/statistik/daten/studie/267974/umfrage/prognose-zum-weltweit-generierten-datenvolumen/} (Last checked: June 9, 2026)}},
