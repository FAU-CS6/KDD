...
\begin{frame}{Data Mining in the Database Community}
	\begin{itemize}
		\item The \textbf{Knowledge discovery pipeline} is a typical view from
...
\begin{frame}{Data Mining in the ML Community}
	The Machine Learning community usually classifies data mining as
	the central part of its pipeline:
