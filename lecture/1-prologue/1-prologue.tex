...
\begin{frame}{When? - Preliminary Schedule}
	...
	\begin{tabular}{|p{4em}|p{21em}|p{21em}|}
		...
		Introduction to pandas \& scikit-learn {\color{gray}(optional)}                                                                                                                          \\ \hline
		...
		\cellcolor{faugray!25}22                    & \multirow{2}{*}{Frequent Pattern}                                           &
		\multirow{2}{*}{Frequent Pattern}                                                                                                                                                        \\
		...
		\cellcolor{faugray!25}28                    & \multirow{2}{*}{Outlier Analysis}                                           & \multirow{2}{*}{Outlier}                                     \\
