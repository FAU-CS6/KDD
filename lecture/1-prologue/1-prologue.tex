...
\begin{frame}{When? - Preliminary Schedule}
	...
	\begin{tabular}{|p{4em}|p{21em}|p{21em}|}
		...
		\cellcolor{faugray!25}26                    &                                                                             &                                                              \\ \hhline{|--|~|}
		\cellcolor{faugray!25}27                    & \multirow{2}{*}{Cluster Analysis}                                           &                                                              \\ \hhline{|-|~|-|}
		\cellcolor{faugray!25}28                    &                                                                             & \multirow{2}{*}{Clustering}                                  \\ \hhline{|--|~|}
		\cellcolor{faugray!25}29                    & \multirow{2}{*}{\shortstack[l]{Outlier Analysis +                                                                                          \\ \textcolor{gray}{Current Research at CS6 and Exam Q\&A}}} &                           \\ \hhline{|-|~|-|}
		\cellcolor{faugray!25}30                    &                                                                             & \cellcolor{gray!50}                                          \\ \hline
	\end{tabular}
\end{frame}
