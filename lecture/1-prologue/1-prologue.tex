...
\begin{frame}{When? - Preliminary Schedule}
	...
	\footnotesize
	\centering
	\begin{tabular}{|p{4em}|p{15em}|p{19em}|p{10em}|}
		\hline
		\rowcolor{faugray!62}\textbf{Calendar Week} & \textbf{Lecture}                                                 & \textbf{Exercise}                                            & \textbf{Submission}                                 \\ \hhline{*{4}{:=}:}
		\cellcolor{faugray!25}16                    & Prologue + Introduction                                          & \cellcolor{gray!50}                                          & \cellcolor{gray!50}                                 \\ \hhline{|-|-|-|-|}
		\cellcolor{faugray!25}17                    & Data                                                             & Introduction to Python \& pandas {\color{gray}(optional)}    & \cellcolor{gray!50}                                 \\ \hhline{|-|-|-|-|}
		\cellcolor{faugray!25}18                    & \multirow{2}{*}{Preprocessing}                                   & \multirow{3}{*}[-0.6em]{Data Analysis \& Data Preprocessing} & \cellcolor{gray!50}                                 \\ \hhline{|-|~|~|-|}
		\cellcolor{faugray!25}19                    &                                                                  &                                                              & \cellcolor{gray!50}                                 \\ \hhline{|--|~|-|}
		\cellcolor{faugray!25}20                    & \textcolor{gray}{Guest lecture} +\newline Data Warehousing       &                                                              & \cellcolor{gray!50}                                 \\ \hhline{|-|-|-|-|}
		\cellcolor{faugray!25}21                    & \cellcolor{gray!50}                                              & \cellcolor{gray!50}                                          & \cellcolor{gray!50}                                 \\ \hhline{|-|-|-|-|}
		\cellcolor{faugray!25}22                    & \multirow{2}{*}{Frequent Pattern}                                & \cellcolor{gray!50}                                          & \cellcolor{gray!50}                                 \\ \hhline{|-|~|-|-|}
		\cellcolor{faugray!25}23                    &                                                                  & \multirow{2}{*}{Frequent Pattern}                            & \cellcolor{gray!50}                                 \\ \hhline{|-|-|~|-|}
		\cellcolor{faugray!25}24                    & \multirow{2}{*}{Classification}                                  &                                                              & \multirow{2}{*}{\cellcolor{white}Frequent Patterns} \\ \hhline{|-|~|-|~|}
		\cellcolor{faugray!25}25                    &                                                                  & \multirow{3}{*}{Classification}                              &                                                     \\ \hhline{|-|-|~|-|}
		\cellcolor{faugray!25}26                    & \multirow{2}{*}{Cluster Analysis}                                &                                                              & \multirow{2}{*}{\cellcolor{white}Classification}    \\ \hhline{|-|~|~|~|}
		\cellcolor{faugray!25}27                    &                                                                  &                                                              &                                                     \\ \hline
		\cellcolor{faugray!25}28                    & \multirow{2}{*}{Outlier Analysis \textcolor{gray}{+ Exam Q\&A }} & \multirow{2}{*}{Clustering}                                  & \multirow{2}{*}{\cellcolor{white}Clustering}        \\ \hhline{|-|~|~|~|}
