		...
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item \textbf{Exercises} - Start in Calendar Week 17
				      \begin{itemize}
					      \item Group 1: Monday, 16:15 - 17:45 (H4) \\
					            {\color{gray}Tutor: Hanna Sepitani}
					      \item Group 2: Tuesday, 12:15 - 13:45 (H4) \\
					            {\color{gray}Tutor: Mohammad Salahuddin Parvez}
					      \item Group 3: Wednesday, 14:15 - 15:45 (H4) \\
					            {\color{gray}Tutor: Olga Zotova}
					      \item Group 4: Thursday, 10:15 - 11:45 (H4) \\
					            {\color{gray}Tutor: Shree Varshan Babu}
					      \item Group 5: Friday, 14:15 - 15:45 (H4) \\
...
\begin{frame}{When? - Preliminary Schedule}
	...
	\begin{tabular}{|p{4em}|p{15em}|p{9.5em}|p{9.5em}|p{10em}|}
		...
		\cellcolor{faugray!25}27                    & \multirow{2}{*}{Outlier Analysis} & \multicolumn{2}{|c|}{\multirow{2}{*}{Clustering}}                               & \multirow{2}{*}{\cellcolor{white}Clustering}       \\ \hhline{|-|~|~~|~|}
...
\begin{frame}{Where? - StudOn}
	...
	\begin{columns}
		\begin{column}{0.8\textwidth}
			\begin{itemize}
				\item Register at: \\ \url{https://www.studon.fau.de/studon/go/crs/6151916/rcodedTkQDYDgP8}
		...
		\begin{column}{0.2\textwidth}
			\begin{center}
				\qrcode{https://www.studon.fau.de/studon/go/crs/6151916/rcodedTkQDYDgP8}
			\end{center}
		\end{column}
	\end{columns}
