	...
	\begin{center}
		\resizebox{0.65\textwidth}{!}{
			\begin{tabular}{|l|l|l|}
				...
				18                     & Data                                                & \multirow{2}{*}{Introduction to Python} \\ \cline{1-2}
				19                     & \multirow{2}{*}{Preprocessing}                      &                                         \\ \cline{1-1} \cline{3-3}
				20                     &                                                     & \multirow{3}{*}{Data}                   \\ \cline{1-2}
				21                     & {\color{gray}Guest lecture (Siemens Energy) +} OLAP &                                         \\ \cline{1-2}
				22                     & \multirow{2}{*}{Frequent Pattern}                   &                                         \\ \cline{1-1} \cline{3-3}
				23                     &                                                     & Frequent Pattern                        \\ \hline
