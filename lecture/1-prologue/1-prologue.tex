\begin{frame}{Who? - Lecturer and Tutors}
	...
	\only<1->{
		...
		\begin{columns}[T]
			...
			\begin{column}{0.6\textwidth}
				...
				\textit{Lecturer and Primary Contact}
				\begin{itemize}
		...
		\only<2>{
			...
			\begin{block}{Side Note: I am not a Dr. or Prof.!}
				Please address me as \textit{\glqq Mr. Probst\grqq}, as I would otherwise be obliged to correct you each time in order to avoid assuming a title I do not hold.
			\end{block}
		}
	}
	...
	\only<4->{
		...
		\begin{columns}[T]
			...
			\begin{column}{0.35\textwidth}
				\begin{center}
					\begin{itemize}
						\item Shree Varshan Babu
						\item Mahmoud Elboghdady
						\item Hanna Septiani
					\end{itemize}
				\end{center}
			\end{column}
			\begin{column}{0.35\textwidth}
				\begin{center}
					\begin{itemize}
						\item Mohammad Salahuddin Parvez
						\item Olga Zotova
					\end{itemize}
				\end{center}
			\end{column}
...
\begin{frame}{For whom? - Courses of Study}
	% Study programs
	\begin{itemize}
		\item \textbf{Knowledge Discovery in Databases with Exercises (KDDmUe)} - 5 ECTS
		      \begin{itemize}
...
\begin{frame}{Why? - Exercises}
	\begin{itemize}
		\item \textbf{Summer Semester 2024:}
		      \begin{itemize}
			...
			\scalebox{0.75}{
				\begin{tikzpicture}
					\begin{axis}[
						...
						\draw[pattern=north east lines, pattern color=red, fill opacity=0.1, draw=none] (0,-0.6) rectangle (axis cs:50,2.6);
...
\begin{frame}{What? - Exam}
	...
	\begin{itemize}
		\item \textbf{Knowledge Discovery in Databases with Exercise (KDDmUe)} - {\color{faugray}Written Exam}
		      \begin{itemize}
			      ...
			      \item Content: Questions on lecture, exercise \underline{and} submission content
			      \item Language: English
			      \item Permitted helpers: Single-sided, handwritten DIN A4 cheat sheet
			      \item Not permitted: Electronic devices (including calculators)
		      \end{itemize}
	\end{itemize}
	...
	\begin{alertblock}{Important: Do Not Forget To Register!}
		...
		\begin{itemize}
			\item \textbf{(Provisional) Registration Period:} May 18 (00:01) until June 7, 2026 (23:59)
		...
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item \textbf{Lecture} - Start in Calendar Week 16 (Today)
				      \begin{itemize}
					      \item Wednesday, 08:15 - 09:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=7761&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H20}) \\
					            (\textit{Live stream and recording avbl. via StudOn})
					            {\color{gray}Lecturer: Dominik Probst}
				      \end{itemize}
				      }
				      \visible<2->{
				\item \textbf{Guest lecture} - One time: July 10
				      \begin{itemize}
					      \item Friday, 10:15 - 11:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=7785&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H18}) \\
					            {\color{gray}Lecturer: Daniel Krauss \\
					            (Co-Founder and CIO \href{https://www.flix.com/}{@Flix})}
				      \end{itemize}
				      \begin{columns}[T]
					      \begin{column}{0.2\textwidth}
						      \hfill
					      ...
					      \begin{column}{0.27\textwidth}
						      ...
						      \begin{figure}[t]
							      \centering
							      \includegraphics[height=0.6cm]{img/flix/flixbus.png} % Note for SS27: Remove the images from the repository 
						      \end{figure}
					      \end{column}
					      \begin{column}{0.33\textwidth}
						      ...
						      \begin{figure}[t]
							      \centering
							      \includegraphics[height=0.6cm]{img/flix/flixtrain.png} % Note for SS27: Remove the images from the repository 
						      \end{figure}
					      \end{column}
					      \begin{column}{0.2\textwidth}
						      \hfill
		...
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item \textbf{Exercises} - Start in Calendar Week 17
				      \begin{itemize}
					      \item Group 1: Monday, 16:15 - 17:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=3702&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H4}) \\
					            {\color{gray}Tutor: Hanna Septiani}
					      \item Group 2: Tuesday, 12:15 - 13:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=3702&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H4}) \\
					            {\color{gray}Tutor: Mohammad Salahuddin Parvez}
					      \item Group 3: Wednesday, 14:15 - 15:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=3702&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H4}) \\
					            {\color{gray}Tutor: Olga Zotova}
					      \item Group 4: Thursday, 10:15 - 11:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=3702&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H4}) \\
					            {\color{gray}Tutor: Shree Varshan Babu}
					      \item Group 5: Friday, 14:15 - 15:45 (\href{https://www.campo.fau.de:443/qisserver/pages/startFlow.xhtml?_flowId=showRoomDetail-flow&roomId=3702&roomType=3&context=showRoomDetail&navigationPosition=organisation,hisinoneFacilities,hisinonesearchroom}{H4}) \\
					            {\color{gray}Tutor: Mahmoud Elboghdady}
				      \end{itemize}
				      }
			\end{itemize}
		\end{column}
	...
	\visible<4->{
		\begin{block}{Registration For The Exercises}
			Registration for exercises is mandatory to ensure an appropriate support to questions regarding setting of exercises should they arise.
				{\color{faured}Registration opens at April 15th, 10:00 via StudOn.}
		\end{block}
	}
\end{frame}
...
\begin{frame}{When? - Preliminary Schedule}
	...
	\begin{tabular}{|p{4em}|p{15em}|p{9.5em}|p{9.5em}|p{10em}|}
		...
		\cellcolor{faugray!25}17                    & Data                                                                                                                             & \multicolumn{2}{|c|}{Introduction to Python \& pandas {\color{gray}(optional)}} & \cellcolor{gray!50}                                \\ \hhline{|-|-|--|-|}
		\cellcolor{faugray!25}18                    & \multirow{2}{*}{Preprocessing}                                                                                                   & \multicolumn{2}{|c|}{\multirow{3}{*}{Data Analysis \& Data Preprocessing}}      & \cellcolor{gray!50}                                \\ \hhline{|-|~|~~|-|}
		\cellcolor{faugray!25}19                    &                                                                                                                                  & \multicolumn{2}{|l|}{}                                                          & \cellcolor{gray!50}                                \\ \hhline{|-|-|~~|-|}
		\cellcolor{faugray!25}20                    & Data Warehousing                                                                                                                 & \multicolumn{2}{|l|}{}                                                          & \cellcolor{gray!50}                                \\ \hhline{|-|-|--|-|}
		\cellcolor{faugray!25}21                    & \multirow{2}{*}{Frequent Pattern}                                                                                                & \multicolumn{2}{|c|}{\cellcolor{gray!50}}                                       & \cellcolor{gray!50}                                \\ \hhline{|-|~|--|-|}
		\cellcolor{faugray!25}22                    &                                                                                                                                  & \multicolumn{2}{|c|}{\multirow{2}{*}{Frequent Pattern}}                         & \cellcolor{gray!50}                                \\ \hhline{|-|-|~~|-|}
		\cellcolor{faugray!25}23                    & \multirow{2}{*}{Classification}                                                                                                  & \multicolumn{2}{|l|}{}                                                          & \multirow{2}{*}{\cellcolor{white}Frequent Pattern} \\ \hhline{|-|~|--|~|}
		\cellcolor{faugray!25}24                    &                                                                                                                                  & \multicolumn{2}{|c|}{\multirow{3}{*}{Classification}}                           &                                                    \\ \hhline{|-|-|~~|-|}
		\cellcolor{faugray!25}25                    & \multirow{2}{*}{Cluster Analysis}                                                                                                & \multicolumn{2}{|c|}{}                                                          & \multirow{2}{*}{\cellcolor{white}Classification}   \\ \hhline{|-|~|~~|~|}
		\cellcolor{faugray!25}26                    &                                                                                                                                  & \multicolumn{2}{|l|}{}                                                          &                                                    \\ \hhline{|-|-|--|-|}
		\cellcolor{faugray!25}27                    & \multirow{2}{*}{\adjustbox{valign=m}{Outlier Analysis +}\adjustbox{valign=m}{\includegraphics[height=0.4cm]{img/flix/flix.png}}} & \multicolumn{2}{|c|}{\multirow{2}{*}{Clustering}}                               & \multirow{2}{*}{\cellcolor{white}Clustering}       \\ \hhline{|-|~|~~|~|}
		\cellcolor{faugray!25}28                    &                                                                                                                                  & \multicolumn{2}{|c|}{}                                                          &                                                    \\ \hhline{|-|-|--|-|}
		\cellcolor{faugray!25}29                    & Exam Q\&A                                                                                                                        & \multicolumn{2}{|l|}{\cellcolor{gray!50}}                                       & \cellcolor{gray!50}                                \\ \hline
	\end{tabular}
...
\begin{frame}{Where? - StudOn}
	...
	\begin{columns}
		\begin{column}{0.8\textwidth}
			\begin{itemize}
				\item Register at: \\ \url{https://www.studon.fau.de/studon/go/crs/6792338}
				\item Main source for resources. E.g.:
				      \begin{itemize}
					      \item Lecture slides
					      \item Exercise sheets
					      \item Submission sheets
					      \item Forum
				      \end{itemize}
				\item Membership required to receive important updates on KDD
		...
		\begin{column}{0.2\textwidth}
			\begin{center}
				\qrcode{https://www.studon.fau.de/studon/go/crs/6792338}
			\end{center}
		\end{column}
	\end{columns}
