...
\begin{frame}{What? - Goal and Topics}
	...
	\begin{itemize}
		...
		\item \textbf{Topics in the exercise:}
		      ...
		      \begin{multicols}{2}
			      \begin{enumerate}
				      \item Introduction to pandas and scikit-learn {\color{gray}optional}
...
\begin{frame}{When? - Preliminary Schedule}
	...
	\begin{tabular}{|p{4em}|p{21em}|p{21em}|}
		\hline
		\rowcolor{faugray!62}\textbf{Calendar Week} & \textbf{Lecture}                                                            & \textbf{Exercise}                                               \\ \hline\hline
		\cellcolor{faugray!25}17                    & Prologue + Introduction                                                     & \cellcolor{gray!50}                                             \\ \hline
		\cellcolor{faugray!25}18                    & Data                                                                        & Introduction to pandas \& scikit-learn {\color{gray}(optional)} \\ \hline
		\cellcolor{faugray!25}19                    & \multirow{2}{*}{Preprocessing}                                              & \multirow{3}{*}[-0.6em]{Data Analysis \& Data Preprocessing}    \\ \cline{1-1}
		\cellcolor{faugray!25}20                    &                                                                             &                                                                 \\ \cline{1-2}
		\cellcolor{faugray!25}21                    & \textcolor{gray}{Guest lecture (Siemens Energy)} +\newline Data Warehousing &                                                                 \\ \hline
		\cellcolor{faugray!25}22                    & \multirow{2}{*}{Frequent Pattern}                                           & \multirow{2}{*}{Frequent Pattern}                               \\ \cline{1-1}
		\cellcolor{faugray!25}23                    &                                                                             &                                                                 \\ \hline
		\cellcolor{faugray!25}24                    & \multirow{2}{*}{Classification}                                             & \multirow{2}{*}{Classification}                                 \\ \cline{1-1}
		\cellcolor{faugray!25}25                    &                                                                             &                                                                 \\ \hline
		\cellcolor{faugray!25}26                    & \multirow{2}{*}{Cluster Analysis}                                           & \multirow{2}{*}{Clustering}                                     \\ \cline{1-1}
		\cellcolor{faugray!25}27                    &                                                                             &                                                                 \\ \hline
		\cellcolor{faugray!25}28                    & \multirow{2}{*}{Outlier Analysis}                                           & \multirow{2}{*}{Outlier}                                        \\ \cline{1-1}
		\cellcolor{faugray!25}29                    &                                                                             &                                                                 \\ \hline
		\cellcolor{faugray!25}30                    & Current Research at CS6 + Exam Q\&A                                         & \cellcolor{gray!50}                                             \\ \hline
	\end{tabular}
\end{frame}
	...
	\begin{columns}
		\begin{column}{0.7\textwidth}
			\begin{itemize}
				...
				\item Version control of our resources inlcuding:
				      \begin{itemize}
					      \item Lecture slides
					      \item Exercise sheets
				      \end{itemize}
