	...
	\begin{columns}
		\begin{column}{0.4\textwidth}
			...
			\begin{tikzpicture}[overlay]
				\node[draw,rectangle,minimum width=16.25em, minimum height=6em, rounded corners=.25em] at (3.25,4.2) (base) {};
				\node[draw,rectangle,minimum width=16.25em, minimum height=6em, rounded corners=.25em] at (3.25,1.62) (transfer) {};
