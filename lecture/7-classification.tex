...
\hypersetup{
	pdftitle={KDDmUe - 7. Classification},
	pdfkeywords={
		KDD, 
		KDDmUe, 
	...
	pdfsubject={Lecture on classification methods: decision trees, rule-based systems, Bayes classifiers, model evaluation metrics, and ensemble techniques.},
