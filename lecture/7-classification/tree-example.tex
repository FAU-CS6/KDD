\begin{tikzpicture}[
	...
	\node[leaf,text=faured,below left=2.5em and -1em of student] (student-no) {no};
	\node[leaf,text=faugreen,below right=2.5em and -1em of student] (student-yes) {yes};
