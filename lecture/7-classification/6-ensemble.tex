...
\begin{frame}{Ensemble Methods}
	\begin{block}{Ensemble Method}
		An \textit{Ensemble Method} is a composite model that consits of several models such as to form one model.
	\end{block}
	\begin{itemize}
...
\begin{frame}{Bagging: Boostrap Aggregation}
	\begin{itemize}
		...
		\item \textbf{Training:}
		      ...
		      \end{itemize}
		\item \textbf{Predicton in the case of classification: classify an unknown sample $X$.}
		      \begin{itemize}
