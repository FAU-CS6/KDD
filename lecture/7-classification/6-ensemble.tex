...
\begin{frame}{Ensemble Methods}
	\begin{block}{Ensemble Method}
		...
		% REVIEW: I disagree with this definition on one important point:
		% In my opinion, Ensemble Methods are, as the name suggests, the methodology to create a composite model from multiple models and not the composite model itself.
		% All definitions I could find during a quick internet search seem to confirm this. I have to admit that I have not found the source of the definition above.
	\end{block}
	\begin{itemize}
