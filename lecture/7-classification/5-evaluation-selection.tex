...
\begin{frame}{Estimating Confidence Intervals (II) - WIP}
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\vspace*{-0.7cm}
			...
			\begin{center}
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\addplot[faureddark, thick] {0.4*(1+(x*x/5))^(-3)};
						\addplot[fill=faugraydark!20, opacity=0.6, draw=none, domain=-4:-2] {0.4*(1+(x*x/5))^(-3)} \closedcycle;
						\draw[dashed] (axis cs:0,0) -- (axis cs:0,0.4);
						\node[anchor=north west, font=\footnotesize] at (axis cs:-3.0,0.11) {Area};
					\end{axis}
				\end{tikzpicture}
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\addplot[faureddark, thick] {0.4*(1+(x*x/5))^(-3)};
						\addplot[fill=faugraydark!20, opacity=0.6, draw=none, domain=2:4] {0.4*(1+(x*x/5))^(-3)} \closedcycle;
						\draw[dashed] (axis cs:0,0) -- (axis cs:0,0.4);
						\node[anchor=north east, font=\footnotesize] at (axis cs:3.0,0.11) {Area};
					\end{axis}
				\end{tikzpicture}
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\addplot[fill=faugraydark!20, opacity=0.6, draw=none, domain=2:4] {0.4*(1+(x*x/5))^(-3)} \closedcycle;
						\draw[dashed] (axis cs:0,0) -- (axis cs:0,0.4);
						\node[anchor=north west, font=\footnotesize] at (axis cs:-3.0,0.11) {$\frac{\text{Area}}{2}$};
						\node[anchor=north east, font=\footnotesize] at (axis cs:3.0,0.11) {$\frac{\text{Area}}{2}$};
					\end{axis}
				\end{tikzpicture}
			\end{center}
		\end{column}
		...
		\begin{column}{0.35\textwidth}
			...
			\scalebox{0.8}{
				\begin{tabular}{c|ccc}
					\textbf{}                        & \multicolumn{3}{c}{\textbf{Area in One Tail}}                                                             \\
					\textbf{}                        & \textbf{0.100}                                 & \textbf{0.050}             & \textbf{0.005}              \\ \cline{2-4}
					\textbf{}                        & \multicolumn{3}{c}{\textbf{Area in Two Tails}}                                                            \\
