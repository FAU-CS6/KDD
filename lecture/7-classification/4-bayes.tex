		...
		\begin{column}{0.45\textwidth}
			...
			\visible<2->{
				\begin{align*}
					...
					P(\texttt{student} = "yes" | {\color{faugreen}yes})         & = \visible<7->{\frac{6}{9} \approx 0.667} \\
		...
		\begin{column}{0.45\textwidth}
			...
			\only<8->{
				...
				\vspace*{-0.15cm}
				{
					\scriptsize
					\begin{align*}
						P(X | {\color{faugreen}yes}) & = \visible<9->{0.222 \cdot 0.444 \cdot 0.667 \cdot 0.667 \approx 0.044} \\
				...
				\visible<11->{
					...
					\vspace*{-0.15cm}
					{
						...
						\visible<12->{
							\begin{align*}
								P(X | {\color{faugreen}yes}) \cdot  P({\color{faugreen}yes}) & = 0.028. \\
