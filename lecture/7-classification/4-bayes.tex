		      ...
		      \begin{itemize}
			      ...
			      \item Practically, \textbf{dependencies} exist among most variables.
			            \begin{itemize}
				            ...
				            \item \textbf{\color{airforceblue}How to deal with these dependencies?} \\ $\rightarrow$ Bayesian Belief Networks (not part of KDD\footnote{\textbf{More info in our reference book (Chapter 9.1):} \fullcite{han2011}}).
			            \end{itemize}
		      \end{itemize}
	\end{itemize}
\end{frame}
