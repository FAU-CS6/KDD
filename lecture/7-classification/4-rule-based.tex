...
\begin{frame}{Sequential Covering Algorithm (I): Basic Algorithm}
	\begin{algorithm}[H]
		\SetAlgoVlined
		\KwData{
			\begin{itemize}
...
\begin{frame}{Sequential Covering Algorithm (II): How Rules are Learned}
	\begin{itemize}
...
\begin{frame}{Sequential Covering Algorithm (III): Rule Space}
	\vspace*{-1em}
	\begin{figure}[h]
		\centering
