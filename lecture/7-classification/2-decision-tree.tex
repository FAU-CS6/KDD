...
\begin{frame}{Algorithm for Decision-Tree Induction (cont'd)}
...
\begin{frame}{Attribute Selection Measures: Information Gain (ID3)}
	\begin{itemize}
...
\begin{frame}{Attribute Selection Measures: Information Gain (ID3) (cont'd)}
...
\begin{frame}{Gini Index (CART, IBM IntelligentMiner) (cont'd)}
	\begin{itemize}
